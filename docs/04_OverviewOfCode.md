...
To see an example of how the lattice class can be instantiated and used, refer to the `lattice_hamiltonian\RunLattice.py` file. If you would like to try running the code, you can use the `notebooks\WorkedExample.ipynb` notebook to see how changing the electronic coupling affects the energies and distributions of the system's eigenstates. 
