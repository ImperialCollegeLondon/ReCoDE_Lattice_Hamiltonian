...
def FCWD_single_nm_v2(n, m, lambda_inner, e_peak, lambda_outer, w):
...
def calc_FCWD_total(lambda_inner, e_peak, lambda_outer, w, N = 20, M = 6):
    kT = 0.0257 
    FCWD_total = 0
...
def decay_rate(lambda_inner, e_peak, lambda_outer, w, v):
